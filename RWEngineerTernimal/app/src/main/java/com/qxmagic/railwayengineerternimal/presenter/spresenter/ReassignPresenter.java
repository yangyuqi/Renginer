...
public class ReassignPresenter implements IResolvedPresenter {
    private final Context mContext;
    private final IEventView mView;
    private int page = 1;

    public ReassignPresenter(Context mContext, IEventView mView) {
    ...
    public void getData() {
        //发送请求获得未解决事件集合并返回
        page = 1;
        RetrofitService.getReSigndList(getParams()).doOnSubscribe(new Action0() {
            @Override
            public void call() {
