 ...
 * 新建变更presenter
 */
public class NewChangePresenter implements INewVariousPresenter {
    private INewChangeView mView;
    private Context mContext;

    public NewChangePresenter(INewChangeView mView, Context mContext) {
        this.mView = mView;
    ...
    @Override
    public void getData() {
        RetrofitService.getApproveList(RequestUtil.getCommonParams()).doOnSubscribe(new Action0() {
            @Override
            public void call() {
    ...
    public void newVarious(HashMap<String, String> params) {
        //发送新建请求并返回结果
        RetrofitService.newChange(params).doOnSubscribe(new Action0() {
            @Override
            public void call() {
...
//                }
    ...
    public void checkTitle(String title) {
        ...
        map.put("title",title);
        RetrofitService.checkChangeTitle(map).doOnSubscribe(new Action0() {
            @Override
            public void call() {
