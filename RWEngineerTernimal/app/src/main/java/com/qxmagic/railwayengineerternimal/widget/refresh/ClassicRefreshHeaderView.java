package com.qxmagic.railwayengineerternimal.widget.refresh;
...
import com.qxmagic.railwayengineerternimal.library.recyclerview.RefreshTrigger;
...
public class ClassicRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public ClassicRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, R.layout.layout_hrecyclerview_refresh_header_view, this);
