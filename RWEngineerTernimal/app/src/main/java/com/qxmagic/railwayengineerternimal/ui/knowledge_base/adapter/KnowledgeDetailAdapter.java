...
public class KnowledgeDetailAdapter extends BaseRecyclerViewAdapter<CommonDetailBean> {
    public KnowledgeDetailAdapter(List<CommonDetailBean> mList, Context mContext) {
