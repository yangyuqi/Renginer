...
public class LoginUtil {
    ...
    public static void saveLoginInfo(Context context, UserBean userItem) {
        if (null != userItem) {
            ...
            RWETApplication.getInstance().mLoginUser = userItem;
...
//                "");
        ...
        RWETApplication.getInstance().mLoginUser = null;
    }
    ...
    public static void updateUserPortrait(Context mContext, String imgUrl) {
        ...
        if (null != RWETApplication.getInstance().mLoginUser) {
            RWETApplication.getInstance().mLoginUser.userPortrait = imgUrl;
        }
    }
    ...
    public static void updateUsername(Context mContext, String username) {
        ...
        if (null != RWETApplication.getInstance().mLoginUser) {
            RWETApplication.getInstance().mLoginUser.username = username;
        }
    }
    ...
    public static void updateUserPhone(Context mContext, String phone) {
        ...
        if (null != RWETApplication.getInstance().mLoginUser) {
            RWETApplication.getInstance().mLoginUser.phone = phone;
        }
    }
    ...
    public static void updateUserPassword(Context mContext, String password) {
        ...
        if (null != RWETApplication.getInstance().mLoginUser) {
            RWETApplication.getInstance().mLoginUser.password = password;
        }
    }
    ...
    public static String getUserId(Context context) {
        ...
        String userId;
        if (null != RWETApplication.getInstance()
                && null != RWETApplication.getInstance().mLoginUser
                && !TextUtils.isEmpty(RWETApplication.getInstance().mLoginUser.userId)) {
            userId = RWETApplication.getInstance().mLoginUser.userId;
        } else {
    ...
    public static String getUserName(Context context) {
        ...
        if (null != RWETApplication.getInstance()
                && null != RWETApplication.getInstance().mLoginUser
                && !TextUtils.isEmpty(RWETApplication.getInstance().mLoginUser.username)) {
            userName = RWETApplication.getInstance().mLoginUser.username;
        } else {
    ...
    public static void startLogin(Context mContext) {
        if (null == mContext) {
            ...
            mContext = RWETApplication.getInstance().getApplicationContext();
        }
