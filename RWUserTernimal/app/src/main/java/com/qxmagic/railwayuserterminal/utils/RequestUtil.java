...
public class RequestUtil {
    ...
    public static HashMap<String, String> getCommonParams() {
        ...
        if (null != RWUTApplication.getInstance().mLoginUser) {
            uid = RWUTApplication.getInstance().mLoginUser.userId;
            tokenD = RWUTApplication.getInstance().mLoginUser.token;
        }
    ...
    public static String getTokenKey(Context mContext) {
        String tokenKey = "";
        if (null != RWUTApplication.getInstance().mLoginUser) {
            tokenKey = RWUTApplication.getInstance().mLoginUser.token;
        } else {
