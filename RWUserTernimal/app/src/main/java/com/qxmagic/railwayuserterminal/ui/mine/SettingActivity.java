...
import com.qxmagic.railwayuserterminal.api.download.DownloadIntentService;
...
import com.qxmagic.railwayuserterminal.presenter.spresenter.SettingPresenter;
    ...
    public void getNewVersion(final VersionItem versionItem) {
        CommonDialog mUpdateDialog = new CommonDialog(mContext, "更新提示", "是否升级到" + versionItem.versionName + "版本？\n" + versionItem.description,
            ...
            public void onConfirmClick() {
                ...
                startService(intent);
                RWUTApplication.getInstance().isInstalling = true;
            }
        });
...
//                    mDialog.cancelBackKey();
            ...
            case R.id.setting_check_update:
                if (!RWUTApplication.getInstance().isInstalling) {
